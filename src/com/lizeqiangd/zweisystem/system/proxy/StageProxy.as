package com.lizeqiangd.zweisystem.system.proxy
{
	...
	public class StageProxy
	{
		...
		/**
		 * 将方法添加到Resize中.这是一个便利的方法,不需要声明一堆事件,直接调用就ok.相当方便
		 */
		public static function addResizeFunction(_arg1:Function, immediatitly:Boolean = false):void
		{
			if (!(_resizeFuncs[_arg1] is Function))
			{
				_resizeFuncs[_arg1] = _arg1;
				if (immediatitly) _arg1();
			}
		}
		 ...
		 */
		public static function updateStageResize():void
		{
			_resize(null);
		}
		...
		public static function enableRightClick(enable:Boolean = false):void
		{
			...
			if (enable)
			{
				_stage.removeEventListener('rigthClick', onRightClick)
			...
			{
				if (!_stage.hasEventListener('rigthClick'))
				{
					_stage.addEventListener('rigthClick', onRightClick);
		...
		public static function changeToFullscreen():void
		{
			_stage.displayState = StageDisplayState.FULL_SCREEN
		}
		
		public static function changeToNormal():void
		{
