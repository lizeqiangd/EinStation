package com.lizeqiangd.nuigesture.manager
{
	...
	import com.lizeqiangd.nuigesture.data.Zone
	import com.lizeqiangd.nuigesture.NuiSettings;
	public class ZoneManager
	{
		public  const ignoreZone:String = "igonere";
		public  const gestureZone:String = "gesture";
		public  const controlZone:String = "control";
		public  const selectionZone:String = "selection";
		private  var _ignoreZone:Zone;
		private  var _gestureZone:Zone;
		private  var _controlZone:Zone;
		private  var _selectionZone:Zone;
		private  var zoneArray:Array;
		...
		public  function searchInZone(handDistand:Number):String
		{
