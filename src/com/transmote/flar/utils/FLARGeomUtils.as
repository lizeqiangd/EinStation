	...
	public class FLARGeomUtils {
		...
		public static function convertFLARMatrixToFlashMatrix (fm:FLARDoubleMatrix34, scale:Number=1.0) :Matrix3D {
			return new Matrix3D (Vector.<Number>([
				fm.m00*scale,	fm.m10*scale,	fm.m20*scale,					0,
				-fm.m01*scale,	-fm.m11*scale,	-fm.m21*scale,					0,
				-fm.m02*scale,	-fm.m12*scale,	-fm.m22*scale,					0,
				fm.m03*scale,	fm.m13*scale,	fm.m23*scale+FLAR_Z_OFFSET,		1
				]));
		}
